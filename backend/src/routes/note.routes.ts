...
import { uploadNote, getNotes, fuzzySearch, deleteNote, getMyNotes, getMyFavorites, addComment, getComments, summarizeNote, deleteComment } from '../controllers/note.controller';
